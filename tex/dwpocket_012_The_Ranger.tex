...
\subsection{Viper's Strike}  \index{Viper's Strike} \index{Viper's} \index{Strike}
...
\subsection{Blot out the Sun}  \index{Blot out the Sun} \index{Blot} \index{Sun}
...
\subsection{Viper's Fangs}  \index{Viper's Fangs} \index{Viper's} \index{Fangs}
...
\subsection{Smaug's Belly}  \index{Smaug's Belly} \index{Smaug's} \index{Belly}
