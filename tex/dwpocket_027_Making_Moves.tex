\chapter{Making Moves}
 \index{Making Moves} \index{Moves}
...
\section{Starting Points}  \index{Starting Points} \index{Points}
...
\section{Types of Moves}  \index{Types of Moves} \index{Types} \index{Moves}
...
\section{World Moves}  \index{World Moves} \index{World} \index{Moves}
...
\section{Class Moves}  \index{Class Moves} \index{Class} \index{Moves}
...
\section{New Classes}  \index{New Classes} \index{Classes}
...
\subsection{Compendium Classes}  \index{Compendium Classes} \index{Compendium} \index{Classes}
...
\section{Adventure Moves}  \index{Adventure Moves} \index{Adventure} \index{Moves}
...
\section{Move Structure}  \index{Move Structure} \index{Move} \index{Structure}
...
\subsection{Triggers}  \index{Triggers} \index{Triggers}
...
\subsection{Effect}  \index{Effect} \index{Effect}
...
\section{Changing the Basics}  \index{Changing the Basics} \index{Basics}
...
\section{Development of a Move}  \index{Development of a Move} \index{Development} \index{Move}
...
\section{Agenda, Principles, and GM Moves}  \index{Agenda Principles and GM Moves} \index{Agenda} \index{Principles} \index{Gm} \index{Moves}
...
\subsubsection{The monster is Evil through and through. Choose one to reflect why it's evil:}  \index{The monster is Evil through and through Choose one to reflect why it's evil} \index{Monster} \index{Evil} \index{Choose} \index{Reflect} \index{Evil}
