...
\loadmapfile[ec-softmaker-ttf-s.map]
...
\definecolor[BigColorTwo][r=.9,g=.0,b=.0]
...
\defineparagraphs[MonsterName][n=1,frame=off,offset=none,width=broad,style={\ssbf},strut=no,before={\nowhitespace},after={\nowhitespace}]
...
\defineparagraphs[SpellName][n=1,frame=off,offset=none,width=broad,style={\ssbf},strut=no,before={\nowhitespace},after={\nowhitespace}]
